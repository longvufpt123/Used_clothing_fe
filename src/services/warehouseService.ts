...
export interface ApiClassifiedBatch {
  id:string; batchCode:string; classificationDate:string; fabricType:string; garmentGroup:string;
  clothingType:string; gender:string; targetUser:string; size:string; conditionGrade:string;
  processingDirection:string; totalItem:number; status:string;
}
export interface ApiWarehouseArea {
  id:string; areaName:string; code:string; capacity:number; occupied:number; groupId?:string;
}
export interface ApiAreaGroup { id:string; name:string; code:string; }
export interface ApiInventory {
  id:string; itemCode:string; quantity:number; areaId:string; areaName?:string; classifiedItemId?:string;
}
export interface ApiTransferRequest {
  id:string; code:string; status:string; requestDate:string; sourceWarehouseId?:string;
  targetWarehouseId?:string; items?:unknown[];
}
export interface ApiDistributionRequest {
  id:string; code:string; organizationName:string; status:string; requestDate:string; items?:unknown[];
}
