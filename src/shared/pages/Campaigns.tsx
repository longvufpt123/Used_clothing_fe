...
const INITIAL_CAMPAIGNS: CampaignItem[] = [
  {
    id: 1,
    name: 'Áo ấm mùa đông - Hà Giang 2026',
    targetWeight: 1000,
    collectedWeight: 850,
    deadline: '2026-11-30',
    status: 'active',
  ...
  {
    id: 2,
    name: 'Dự án Sợi Tái Sinh ReThreads',
    targetWeight: 5000,
    collectedWeight: 3890,
    deadline: '2026-12-31',
    status: 'active',
  },
  {
    id: 3,
    name: 'Đồng phục tới trường - Tây Nguyên',
    targetWeight: 800,
    collectedWeight: 800,
    deadline: '2026-06-30',
    status: 'completed',
      ...
      <div className="campaigns-page">
        <div className="admin-page-header">
          ...
          <p className="dashboard-subtitle">
            Tạo chiến dịch từ thiện hoặc tái sinh xơ sợi bông dệt và giám sát sản lượng thu gom.
          </p>
        </div>
          ...
          <div className="campaigns-list-section">
            ...
            {campaigns.length === 0 ? (
              <div className="campaigns-empty">
                <Megaphone size={40} />
                <p>
                  Chưa có chiến dịch nào. Tạo chiến dịch đầu tiên ở khung bên phải để bắt đầu thu
                  gom.
                </p>
              </div>
            ) : (
                      ...
                      <div className="camp-card-body">
                        <div className="camp-meta">
                          <div className="meta-line">
                            <Target size={14} />
                            <span>
                              Mục tiêu: <strong>{camp.targetWeight} kg</strong>
                            </span>
                          </div>
                          <div className="meta-line">
                            <Calendar size={14} />
                            <span>
                              Hạn chót: <strong>{camp.deadline}</strong>
                            </span>
                          </div>
                        </div>
