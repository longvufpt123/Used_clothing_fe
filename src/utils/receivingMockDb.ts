...
const DEFAULT_BATCHES: MockBatch[] = [
  {
    id: 'batch-1',
    code: 'INTAKE-2026-A',
    route: 'Tuyến Quận 1 - Quận 3 (Thu gom nội thành)',
    date: '2026-07-12',
    status: 'Receiving',
  },
  {
    id: 'batch-2',
    code: 'INTAKE-2026-B',
    route: 'Tuyến Bình Thạnh - Phú Nhuận (Gom bưu cục)',
    date: '2026-07-12',
    status: 'Completed',
  },
  {
    id: 'batch-3',
    code: 'INTAKE-2026-C',
    route: 'Tuyến Thủ Đức - Quận 9 (Kho tập trung)',
    date: '2026-07-11',
    status: 'Transferring',
  },
];
...
export const updateRequestStatus = (
  ...
  actualData?: Partial<
    Pick<
      MockRequest,
      'actualWeight' | 'actualCategory' | 'actualCondition' | 'actualNotes' | 'imageUrls'
    >
  >,
) => {
