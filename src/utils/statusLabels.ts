const STATUS_LABELS: Record<string, string> = {
  ...
  SendingToWarehouse: 'Đang gửi sang khu vực lưu trữ', PendingWarehouseReceipt: 'Chờ tiếp nhận lưu trữ',
  SentToWarehouse: 'Đã gửi sang khu vực lưu trữ',
  WarehouseReceived: 'Khu vực lưu trữ đã tiếp nhận', PendingStorage: 'Chờ xếp vị trí',
